...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = const Color(0xFFEDB347),
    ...
    Color backArrowColor = const Color(0xFFEDB347),
    ...
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle(),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle(),
    Color replyTitleColor = const Color(0xFFEDB347),
    ...
    Color verticalBarColor = const Color(0xFFEDB347),
